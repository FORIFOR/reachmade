        ...
        for lang in ['ja','en']:
            for product in PRODUCTS:
                ...
                try:
                    ...
                    report['layouts'].append({'route':route,'width':width,'direction':direction,'headline':h1,'film':film,'lead':lead,'first_try':first_try,'primary_cta':primary,'action_note':note,'video_first':True,'first_action_explicit':True,'conversion_first_narrow':width<1101,'overflow':False,'no_initial_media':True})
