...
export async function build() {
  ...
  console.log(`Built ${routes.length} localized portfolio/product pages + 404. Verified ${showcaseRoutes.length} integrated outcome-first pages. Existing product aliases are unchanged.`);
  return routes;
}
