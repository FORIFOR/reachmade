...
export async function build() {
  ...
  // Preserve main's Request → Result signature, then let outcome-first make the
  ...
  console.log(`Built ${routes.length} localized portfolio/product/guide pages + 404. Verified ${showcaseRoutes.length} signature + outcome-first pages.`);
  return routes;
}
