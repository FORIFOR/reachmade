...
export async function writeOwnedGuides(dist) {
  ...
  for(const lang of ['ja','en']) {
    ...
    const cards=films.map(([id,name,titleJa,titleEn])=>{
      ...
      const caption=id==='prototype'?'orbit':id==='proposal'?'proposal':null;
